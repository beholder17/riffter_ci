...
<?php }?>
	...
	<?php foreach ($content_category_list as $value): ?>
	  <option <?php if ($content[0]['category_id']=$value['id']) echo "selected"; ?> value='<?= $value['id']?>'><?= $value['name']?></option>
	<?php endforeach;?>
	...
	<a id='check_form_data' href='javascript: void(0)'>Применить изменения</a>
	</form>
